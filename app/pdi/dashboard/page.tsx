        ...
        <Container size="xl" py="xl">
          ...
          {loading ? (
            ...
            <Stack gap="xl">
              ...
              {/* Bloque principal — avance global + avance del año + estructura, todo en una sola fila sin repetir información */}
              <Paper
                withBorder
                radius="xl"
                p="xl"
                  ...
                  <SimpleGrid cols={4} spacing="xl" style={{ flex: 1 }}>
                    ...
                    <Box style={{ textAlign: "center" }}>
                      ...
                      <Group gap={10} justify="center" wrap="nowrap">
                        <Box>
                          <Text fw={900} size="1.6rem" lh={1}>{resumen.estructura.indicadores}</Text>
                          <Text size="10px" c="dimmed" fw={600}>{config.anio_fin}</Text>
                        </Box>
                        <Text fw={700} size="1.6rem" c="dimmed" lh={1}>·</Text>
                        <Box>
                          <Text fw={900} size="1.6rem" lh={1}>{resumen.estructura_anio_actual.indicadores}</Text>
                          <Text size="10px" c="dimmed" fw={600}>{resumen.anio_actual}</Text>
                        </Box>
                      </Group>
                      <Text size="sm" c="dimmed" mt={4}>Indicadores</Text>
                    </Box>
                  </SimpleGrid>
